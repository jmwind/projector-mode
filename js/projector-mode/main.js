...
function goProjectorMode() {
    if (!projectorMode) {
        ...
        jQuery("#title-heading .logo").animate({
            width: "hide",
            paddingLeft: "hide",
            paddingRight: "hide",
            marginLeft: "hide",
        ...
        jQuery("#personal-info-sidebar").animate({
            width: "hide",
            paddingLeft: "hide",
            paddingRight: "hide",
            marginLeft: "hide",
            ...
            jQuery("#main").removeClass("has-personal-sidebar")
        });
        if (jQuery("#blog-sidebar")) {
            jQuery("#blog-sidebar").animate({
                width: "hide",
                paddingLeft: "hide",
                paddingRight: "hide",
                marginLeft: "hide",
                ...
                jQuery("#main").removeClass("has-blog-sidebar")
            });
        }
...
function undoProjectorMode() {
    if (projectorMode) {
        ...
        console.log('Can\'t find curtains? ' + curtainImg) /*    var curtainImg = 'http://dl.dropbox.com/u/48692/frontcurtain.jpg';*/
...
$(document).ready(function() {
    $('.projector-mode-web-item').click(function(e) {
        e.preventDefault();
        goProjectorMode();
    });
